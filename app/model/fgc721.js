module.exports = app => {
  ...
  let FGC721 = app.model.define('fgc721', {
    contractAddress: {
      type: CHAR(20).BINARY,
      primaryKey: true
    },
  ...
  FGC721.associate = () => {
    ...
    EVMReceiptLog.belongsTo(FGC721, {as: 'fgc721', foreignKey: 'address', sourceKey: 'contractAddress'})
    FGC721.hasOne(EVMReceiptLog, {as: 'logs', foreignKey: 'address', sourceKey: 'contractAddress'})
    Contract.hasOne(FGC721, {as: 'fgc721', foreignKey: 'contractAddress'})
    FGC721.belongsTo(Contract, {as: 'contract', foreignKey: 'contractAddress'})
  }
