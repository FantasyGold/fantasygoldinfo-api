module.exports = app => {
  ...
  let FGC20 = app.model.define('fgc20', {
    contractAddress: {
      type: CHAR(20).BINARY,
      primaryKey: true
    },
  ...
  FGC20.associate = () => {
    ...
    EVMReceiptLog.belongsTo(FGC20, {as: 'fgc20', foreignKey: 'address', sourceKey: 'contractAddress'})
    FGC20.hasMany(EVMReceiptLog, {as: 'logs', foreignKey: 'address', sourceKey: 'contractAddress'})
    Contract.hasOne(FGC20, {as: 'fgc20', foreignKey: 'contractAddress'})
    FGC20.belongsTo(Contract, {as: 'contract', foreignKey: 'contractAddress'})
  }
