module.exports = app => {
  ...
  router.get(
    '/address/:address/fgc20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.fgc20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/fgc20-txs/:token',
  ...
  router.get(
    ...
    addressMiddleware, paginationMiddleware,
    controller.address.fgc20BalanceHistory
  )
  router.get(
    '/address/:address/fgc20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.fgc20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/fgc20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.fgc20BalanceHistory
  )
  router.get(
    '/contract/:contract/fgc20-balance-history/:token',
  ...
  router.get(
    ...
    controller.fgc20.transactions
  )
  router.get(
    '/fgc20/:token/rich-list',
    middleware.contract('token'), paginationMiddleware,
    controller.fgc20.richList
  )
  router.get(
    '/fgc721',
    paginationMiddleware,
    controller.fgc721.list
  )
