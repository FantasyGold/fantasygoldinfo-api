...
**Request**
```
GET /contract/7564b6686fb62d1de08de677abff9da0a516a692
```

**Response**
```json
{
  "address": "FTse18dmuXHecxJumvwFq1xoxQeFj9N4Ei",
  "addressHex": "7564b6686fb62d1de08de677abff9da0a516a692",
  "vm": "evm",
  "type": "fgc20",
  "fgc20": {
    "name": "FantasyToken",
...
**Request**
```
GET /contract/7564b6686fb62d1de08de677abff9da0a516a692/txs?limit=10&offset=10
```
...
**Request**
```
GET /contract/7564b6686fb62d1de08de677abff9da0a516a692/basic-txs?limit=3&offset=10
```
  ...
  "transactions": [
    {
      ...
      "outputValue": "0",
      "sender": "FTse18dmuXHecxJumvwFq1xoxQeFj9N4Ei",
      "gasUsed": 21614,
    ...
    },
    {
      ...
      "outputValue": "0",
      "sender": "FhHMyzZRN4neqp5SjovBYUVJZneFPcRN9A",
      "gasUsed": 36614,
      "contractAddress": "ESxZUjVBnbeeEyx7E1WhwviAujfRmfCgjU",
      "contractAddressHex": "6b8bf98ff497c064e8f0bde13e0c4f5ed5bf8ce7",
      "excepted": "None",
